...
void reverseBytes(unsigned long x) {
  unsigned long reversedValue = ((x & 0xFF00000000000000ULL) >> (7 * 8)) |
                                ((x & 0x00FF000000000000ULL) >> (5 * 8)) |
                                ((x & 0x0000FF0000000000ULL) >> (3 * 8)) |
                                ((x & 0x000000FF00000000ULL) >> (1 * 8)) |
                                ((x & 0x00000000FF000000ULL) << (1 * 8)) |
                                ((x & 0x0000000000FF0000ULL) << (3 * 8)) |
                                ((x & 0x000000000000FF00ULL) << (5 * 8)) |
                                ((x & 0x00000000000000FFULL) << (7 * 8));
  printf("%lu\n", reversedValue);
}
